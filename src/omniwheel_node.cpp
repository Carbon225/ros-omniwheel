...
static ros::Publisher motorSpeedPub;
static ros::Publisher motorWrenchPub;
...
int main(int argc, char **argv)
{
    ...
    /*ros::Publisher*/ motorSpeedPub = nh.advertise<std_msgs::Float64>("motor", 1);
...
void controlCallback(const geometry_msgs::Twist &twist)
{
    ...
    std_msgs::Float64 motor_control;
    motor_control.data = -wheel_speed * 10;
